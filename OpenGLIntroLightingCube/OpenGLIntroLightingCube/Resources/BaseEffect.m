...
- (void)prepareToDraw
{
    ...
    //ambient lighting
    glUniform3f(_ambientLightingColorUniform, 1.0f, 1.0f, 1.0f);
    glUniform1f(_ambientLightingIntensityUniform, 0.1);
    
    //diffuse lighting
    GLKVector3 diffuseLightDirection = GLKVector3Normalize(GLKVector3Make(0.0f, 1.0f, -1.0f));
    glUniform3f(_diffuseLightingDirectionUniform, diffuseLightDirection.x, diffuseLightDirection.y, diffuseLightDirection.z);
    glUniform1f(_diffuseLightingIntensityUniform, 0.7f);
    
    //specular lighting
    glUniform1f(_materialSpecularLightingIntensityUniform, 1.0);
    glUniform1f(_specularLightingShininessUniform, 8.0f);
}
