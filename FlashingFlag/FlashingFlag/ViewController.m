...
- (void)viewDidLoad
{
    ...
    [self setSecondsPerFlash:2.0];
}

- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
    glClearColor(_currentValue * self.rMult, _currentValue * self.gMult, _currentValue * self.bMult, 1.0);
...
- (void)update
{
    ...
    _currentValue = (sinf(self.timeSinceFirstResume * 2 * M_PI / secondsPerFlash) * 0.5) + 0.5;
